...
export EMD2=$'\xe2\x94\x81\xe2\x94\x81'
...
PS1="\$(if [ \$? = 0 ]; then echo \033[38\;5\;34m$PROMPT_GOOD; else echo \033[38\;5\;160m$PROMPT_BAD; fi) $LINE$EMD5 (\\033[38;5;220m\w$LINE)$EMD5\n\\033[38;5;33m$PROMPT_END\\[\\033[0m "
